...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="fa fa-plus"></i> Inserir novo registro</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <section>
                    ...
                    @endif
                    {!! Form::open(['route' => 'admin.users.store', 'class' => 'form-horizontal form-label-left', 'data-parsley-validate' => '']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::select('role', ['admin' => 'admin', 'manager' => 'manager', 'user' => 'user'], null, ['class' => 'form-control', 'required' => 'required', 'class' => 'form-control col-md-7 col-xs-12']) !!}
                            </div>
                        </div>
                        <div class="item form-group">
                            {!! Form::label('password', 'Senha:', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::password('password', ['class' => 'form-control', 'required' => 'required', 'class' => 'form-control col-md-7 col-xs-12']) !!}
                            </div>
                        </div>
                        <div class="item form-group">
                            {!! Form::label('confirm_password', 'Confirme a senha:', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::password('confirm_password', ['class' => 'form-control', 'required' => 'required', 'class' => 'form-control col-md-7 col-xs-12']) !!}
                            </div>
                        </div>
